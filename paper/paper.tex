...
\begin{enumerate}
  \item El fine-tuning de YOLOv10n sobre un dataset propio de 10 clases de productos de despensa alcanzó un mAP@0.5 de 0.865 en validación y 0.719 en el test split independiente, superando el umbral mínimo de 0.70 establecido para el proyecto y confirmando la viabilidad del enfoque single-stage para este dominio.
  ...
  \item La diferencia de 14.6 puntos entre validación y test (0.865 vs. 0.719) evidencia overfitting atribuible al tamaño reducido del dataset (271 imágenes). Escalar a las $\sim$60 clases del catálogo completo con mayor cantidad de imágenes por clase es la principal línea de trabajo futuro para mejorar la capacidad de generalización.
