...
Las métricas de evaluación~\cite{everingham2010pascal} reportadas son: mean Average Precision a IoU $= 0.5$ (mAP@0.5) y a IoU $\in [0.5, 0.95]$ (mAP@0.5:0.95), precision media y recall medio sobre todas las clases. El hardware de entrenamiento e inferencia se detalla en la \cref{subsec:modelo}.
