...
\begin{abstract}
Este trabajo presenta un sistema de detección de productos en tiempo real para autocobro en una despensa comunitaria. El sistema utiliza YOLOv10, una arquitectura de detección de objetos single-stage que realiza detección y clasificación en un único paso. Se desarrolló un dataset propio con aproximadamente 60 clases de productos típicos de despensa, capturados bajo condiciones controladas con vista cenital. El pipeline incluye una lógica de registro estable que requiere N frames consecutivos de detección antes de confirmar un producto, reduciendo falsos positivos. En la prueba de concepto con 10 clases se obtuvo un mAP@0.5 de 0.87, con inferencia en tiempo real superior a 15 FPS.\todo{Actualizar con métricas del dataset final (60 clases)} El sistema propuesto ofrece una alternativa accesible a soluciones comerciales de autocobro para organizaciones comunitarias.
\end{abstract}
...
\todo{Escribir introducción}

% Contexto: despensa comunitaria, mutual, necesidad de sistema de autocobro
% Problema: soluciones comerciales costosas, no accesibles para organizaciones comunitarias
% Solución propuesta: sistema basado en visión por computadora con YOLOv10
% Contribuciones del trabajo (listar 3-4 puntos)
...
\todo{Completar trabajos relacionados}

\subsection{Detección de Objetos}
% YOLO family (v1 hasta v10)
% RT-DETR como alternativa
% Evolución de arquitecturas single-stage vs two-stage

\subsection{Detección de Productos en Retail}
% RPC Dataset (Retail Product Checkout)
% Desafíos específicos: productos similares, oclusiones, variabilidad

\subsection{Sistemas de Autocobro}
% Soluciones comerciales existentes (Amazon Go, etc.)
% Limitaciones para organizaciones pequeñas

%% ===========================================================================
\section{Metodología}
\label{sec:metodologia}

\todo{Completar metodología}

\subsection{Arquitectura del Sistema}
\label{subsec:arquitectura}
% Diagrama general: Cámara → YOLOv10 → Lógica de registro → Output
% Decisión single-stage vs two-stage
...
% 60 clases de productos típicos de despensa
% Criterios de selección

\subsubsection{Setup de Captura}
% Hardware: cámara, iluminación, mesa
% Posición cenital, distancia, ángulo
% Condiciones controladas

\subsubsection{Protocolo de Captura}
% Tipos de escenas: individual, múltiples productos, con oclusión, con mano
...
% Técnicas aplicadas: mosaic, mixup, flip, rotate
% Justificación
...
% Por qué YOLOv10 y no otras versiones
% Comparación con alternativas (RT-DETR, etc.)

\subsubsection{Variante Seleccionada}
% YOLOv10n/s/m - justificación
...
% N frames de confirmación antes de registrar
% M frames de desaparición antes de eliminar
% Umbral de IoU para matching

\subsubsection{Tracking}
% Decisión: tracker simple basado en IoU
% Por qué no ByteTrack

\subsubsection{Visualización}
% Bounding boxes: verde (confirmado), amarillo (pendiente), naranja (advertencia)
...
\todo{Completar con resultados del modelo final}

\subsection{Configuración Experimental}
% Hardware de entrenamiento
% Hardware de inferencia (Raspberry Pi)
% Métricas utilizadas

\subsection{Prueba de Concepto (10 clases)}
% Resultados preliminares
% mAP@0.5 = 0.87
% Lecciones aprendidas
% Clases problemáticas identificadas

\subsection{Dataset Completo (60 clases)}
\todo{Actualizar con métricas finales}
% Métricas: mAP, precision, recall, F1
% Comparación con POC
...
% Viabilidad del sistema para organizaciones comunitarias
% Impacto potencial


% IEEE prefers the singular form
\section*{Agradecimientos}

\todo{Agregar agradecimientos si corresponde}
% Agradecer a la mutual por el acceso
% Agradecer a profesores/tutores
% Agradecer recursos computacionales si aplica

%%% ===============================================================================
%%% EJEMPLOS DEL TEMPLATE (mantener como referencia, eliminar antes de entregar)
%%% ===============================================================================
