...
Default Ultralytics    & \textbf{0.934} & \textbf{0.790} & 0.821 & \textbf{0.711} \\
Augmentation agresivo  & 0.927 & 0.721 & \textbf{0.859} & 0.642 \\
\hline
\end{tabular}
\end{table}
